<script>
    ...
    const image_path = "assets/pictures/Individuelle_Stillleben/IMG_"
    let curr_image_id = 0
...
<div>
  <div class="landing">
    ...
    <h1 class="big-title">Individuelle Stillleben</h1>
    <h1 class="small-title">Individuelle Stillleben</h1>
    <p class="description">
      Nach der kunstgeschichtlichen Auseinandersetzung mit Stillleben verschiedender Epochen, erprobten und entwickelten die Schülerinnen einen eigenen Stil und setzten diesen in ihrem individuellen Stillleben um.    </p>
    <div>
