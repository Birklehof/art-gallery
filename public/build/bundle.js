...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*placeholder*/ ctx[0] && create_if_block$2(ctx);
    ...
    class Placeholder extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { placeholder: 0, placeholderProps: 1 });
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link: Link$1, Lazy: Src, max_image_id });
    ...
    class Home extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { max_image_id: 0 });
    ...
    /* src/Subject.svelte generated by Svelte v3.46.4 */
    ...
    class Subject extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { max_image_id: 0 });
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:2) <Route path=\\\"subject\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 7, 1, 162);
    			add_location(main, file, 12, 1, 323);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router: Router$1, Route: Route$1, Link: Link$1, Home, Subject });
    	return [];
    }
